...
import AnalyticsManagementPanel from "../../components/admin/AnalyticsManagementPanel";
...
const ADMIN_SECTIONS = [
  ...
  },
  {
    id: "analytics",
    label: "Analytics",
    description: "Real-time traffic, visitors, and page views.",
    icon: BarChart3,
  },
  {
    id: "settings",
...
export default function AdminDashboard() {
  ...
  const renderActivePanel = () => {
    ...
    if (activeSection === "analytics") {
      return <AnalyticsManagementPanel />;
    }
